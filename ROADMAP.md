...
- [ ] Model Switcher — command to change the Anthropic AI model on the fly (with a `/models` command to list them) and warnings about increased API costs/token usage.
